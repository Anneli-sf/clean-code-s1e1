...
var editTask=function(){
  ...
  var containsClass=listItem.classList.contains("edite-list__item");
  ...
  listItem.classList.toggle("edite-list__item");
};
...
//select ListItems children
  var checkBox=taskListItem.querySelector(".task__checked");
